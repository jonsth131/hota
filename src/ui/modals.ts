...
const THEMES: ThemeOption[] = [
  ...
  { id: 'catmocha',    name: 'Catppuccin Mocha', emoji: '☕' },
  { id: 'catlatte',    name: 'Catppuccin Latte', emoji: '🥛' },
  { id: 'solardark',   name: 'Solarized Dark',   emoji: '🌞' },
  { id: 'solarlight',  name: 'Solarized Light',  emoji: '💛' },
